...
class Tutorial:
    ...
    def init_from_kwds(self, kwds):
        """Initiate a tutorial instance from a kwds dictionary"""
    ...
    def init_from_existing_tutorial(self, tuto_name):
        """Initiate a tutorial instance from an existing tutorial (data library and tutorial.md)"""
        self.name = tuto_name
        self.set_dir_name()
